...
The app expects these tabs: CONFIG, USERS, VANS, SPOTS, INSPECTIONS, PHOTOS, DAMAGES, AUDIT_LOG, LISTS, RESCUE_DRIVERS, RESCUES, DAILY_RESCUE_DRIVERS, RESCUES DJX3, and RESCUES DJX4.
...
6. Enable GitHub Pages from the main branch. The root page is already connected to the current Apps Script deployment.
